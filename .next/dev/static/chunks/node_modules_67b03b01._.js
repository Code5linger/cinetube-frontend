...
"[project]/node_modules/@tanstack/react-query-next-experimental/build/modern/htmlescape.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@tanstack/react-query-next-experimental/build/modern/HydrationStreamProvider.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2d$next$2d$experimental$2f$build$2f$modern$2f$htmlescape$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/react-query-next-experimental/build/modern/htmlescape.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-runtime.js [app-client] (ecmascript)");
"use client";
;
;
...
function createHydrationStreamProvider() {
    const context = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"](null);
    function UseClientHydrationStreamProvider(props) {
        const id = `__RQ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useId"]()}`;
        const idJSON = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2d$next$2d$experimental$2f$build$2f$modern$2f$htmlescape$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["htmlEscapeJsonString"])(JSON.stringify(id));
        const [transformer] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]({
            "createHydrationStreamProvider.UseClientHydrationStreamProvider.useState": ()=>props.transformer ?? {
                    // noop
                    serialize: ({
                        "createHydrationStreamProvider.UseClientHydrationStreamProvider.useState": (obj)=>obj
                    })["createHydrationStreamProvider.UseClientHydrationStreamProvider.useState"],
                    deserialize: ({
                        "createHydrationStreamProvider.UseClientHydrationStreamProvider.useState": (obj)=>obj
                    })["createHydrationStreamProvider.UseClientHydrationStreamProvider.useState"]
                }
        }["createHydrationStreamProvider.UseClientHydrationStreamProvider.useState"]);
        const [stream] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]({
            "createHydrationStreamProvider.UseClientHydrationStreamProvider.useState": ()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useServerInsertedHTML"])({
            "createHydrationStreamProvider.UseClientHydrationStreamProvider.useServerInsertedHTML": ()=>{
                stream.push(...props.onFlush?.() ?? []);
                if (!stream.length) {
                    return null;
                }
                const serializedCacheArgs = stream.map({
                    "createHydrationStreamProvider.UseClientHydrationStreamProvider.useServerInsertedHTML.serializedCacheArgs": (entry)=>transformer.serialize(entry)
                }["createHydrationStreamProvider.UseClientHydrationStreamProvider.useServerInsertedHTML.serializedCacheArgs"]).map({
                    "createHydrationStreamProvider.UseClientHydrationStreamProvider.useServerInsertedHTML.serializedCacheArgs": (entry)=>JSON.stringify(entry)
                }["createHydrationStreamProvider.UseClientHydrationStreamProvider.useServerInsertedHTML.serializedCacheArgs"]).join(",");
                stream.length = 0;
                const html = [
                    `window[${idJSON}] = window[${idJSON}] || [];`,
                    `window[${idJSON}].push(${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2d$next$2d$experimental$2f$build$2f$modern$2f$htmlescape$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["htmlEscapeJsonString"])(serializedCacheArgs)});`
                ];
...
"[project]/node_modules/@tanstack/react-query-next-experimental/build/modern/ReactQueryStreamedHydration.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2d$next$2d$experimental$2f$build$2f$modern$2f$HydrationStreamProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/react-query-next-experimental/build/modern/HydrationStreamProvider.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-runtime.js [app-client] (ecmascript)");
"use client";
;
;
;
;
var stream = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2d$next$2d$experimental$2f$build$2f$modern$2f$HydrationStreamProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHydrationStreamProvider"])();
function ReactQueryStreamedHydration(props) {
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"])(props.queryClient);
    const [trackedKeys] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]({
        "ReactQueryStreamedHydration.useState": ()=>/* @__PURE__ */ new Set()
    }["ReactQueryStreamedHydration.useState"]);
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isServer"]) {
    ...
    return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(stream.Provider, {
        onFlush: ()=>{
            const shouldDehydrate = props.options?.dehydrate?.shouldDehydrateQuery ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$hydration$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultShouldDehydrateQuery"];
        ...
        onEntries: (entries)=>{
            for (const hydratedState of entries){
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$hydration$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hydrate"])(queryClient, hydratedState, props.options?.hydrate);
            }
        },
...
//# sourceMappingURL=node_modules_67b03b01._.js.map